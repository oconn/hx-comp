...
(dc/defcard Display20 (hx/f [Display20 test-sentance]))
(dc/defcard Display10 (hx/f [Display10 test-sentance]))
(dc/defcard Title40 (hx/f [Title40 test-sentance]))
(dc/defcard Title30 (hx/f [Title30 test-sentance]))
(dc/defcard Title20 (hx/f [Title20 test-sentance]))
(dc/defcard Title10 (hx/f [Title10 test-sentance]))
(dc/defcard Body30 (hx/f [Body30 test-sentance]))
(dc/defcard Body20 (hx/f [Body20 test-sentance]))
(dc/defcard Body10 (hx/f [Body10 test-sentance]))
(dc/defcard Caption30 (hx/f [Caption30 test-sentance]))
(dc/defcard Caption20 (hx/f [Caption20 test-sentance]))
(dc/defcard Caption10 (hx/f [Caption10 test-sentance]))

(dc/defcard Display20Alt (hx/f [Display20Alt test-sentance]))
(dc/defcard Display10Alt (hx/f [Display10Alt test-sentance]))
(dc/defcard Title40Alt (hx/f [Title40Alt test-sentance]))
(dc/defcard Title30Alt (hx/f [Title30Alt test-sentance]))
(dc/defcard Title20Alt (hx/f [Title20Alt test-sentance]))
(dc/defcard Title10Alt (hx/f [Title10Alt test-sentance]))
(dc/defcard Body30Alt (hx/f [Body30Alt test-sentance]))
(dc/defcard Body20Alt (hx/f [Body20Alt test-sentance]))
(dc/defcard Body10Alt (hx/f [Body10Alt test-sentance]))
(dc/defcard Caption30Alt (hx/f [Caption30Alt test-sentance]))
(dc/defcard Caption20Alt (hx/f [Caption20Alt test-sentance]))
(dc/defcard Caption10Alt (hx/f [Caption10Alt test-sentance]))
